...
class CalendarApi(object):
    ...
    def get_characters_character_id_calendar_with_http_info(self, character_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `character_id` when calling `get_characters_character_id_calendar`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `get_characters_character_id_calendar`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_characters_character_id_calendar_event_id_with_http_info(self, character_id, event_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
                                                       params['character_id'] is None):
            raise ValueError(
                "Missing the required parameter `character_id` when calling `get_characters_character_id_calendar_event_id`")
        # verify the required parameter 'event_id' is set
        if self.api_client.client_side_validation and ('event_id' not in params or
                                                       params['event_id'] is None):
            raise ValueError(
                "Missing the required parameter `event_id` when calling `get_characters_character_id_calendar_event_id`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `get_characters_character_id_calendar_event_id`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_characters_character_id_calendar_event_id_attendees(self, character_id, event_id, **kwargs):
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_characters_character_id_calendar_event_id_attendees_with_http_info(character_id, event_id,
                                                                                                 **kwargs)
            return data
    ...
    def get_characters_character_id_calendar_event_id_attendees_with_http_info(self, character_id, event_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
                                                       params['character_id'] is None):
            raise ValueError(
                "Missing the required parameter `character_id` when calling `get_characters_character_id_calendar_event_id_attendees`")
        # verify the required parameter 'event_id' is set
        if self.api_client.client_side_validation and ('event_id' not in params or
                                                       params['event_id'] is None):
            raise ValueError(
                "Missing the required parameter `event_id` when calling `get_characters_character_id_calendar_event_id_attendees`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `get_characters_character_id_calendar_event_id_attendees`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def put_characters_character_id_calendar_event_id(self, character_id, event_id, response, **kwargs):
        ...
        :param int character_id: An EVE character ID (required)
        :param int event_id: The ID of the event requested (required)
        :param Response response: The response value to set, overriding current value (required)
        :param str datasource: The server name you would like data from
        :param str token: Access token to use if unable to set a header
        :return: None
                 If the method is called asynchronously,
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.put_characters_character_id_calendar_event_id_with_http_info(character_id, event_id, response,
                                                                                       **kwargs)
            return data
    ...
    def put_characters_character_id_calendar_event_id_with_http_info(self, character_id, event_id, response, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
                                                       params['character_id'] is None):
            raise ValueError(
                "Missing the required parameter `character_id` when calling `put_characters_character_id_calendar_event_id`")
        # verify the required parameter 'event_id' is set
        if self.api_client.client_side_validation and ('event_id' not in params or
                                                       params['event_id'] is None):
            raise ValueError(
                "Missing the required parameter `event_id` when calling `put_characters_character_id_calendar_event_id`")
        ...
        if self.api_client.client_side_validation and ('response' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `response` when calling `put_characters_character_id_calendar_event_id`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `put_characters_character_id_calendar_event_id`, must be a value greater than or equal to `1`")
        collection_formats = {}
