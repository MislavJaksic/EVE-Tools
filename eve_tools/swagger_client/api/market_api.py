...
class MarketApi(object):
    ...
    def get_characters_character_id_orders_with_http_info(self, character_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `character_id` when calling `get_characters_character_id_orders`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `get_characters_character_id_orders`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_characters_character_id_orders_history_with_http_info(self, character_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
                                                       params['character_id'] is None):
            raise ValueError(
                "Missing the required parameter `character_id` when calling `get_characters_character_id_orders_history`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `get_characters_character_id_orders_history`, must be a value greater than or equal to `1`")
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_characters_character_id_orders_history`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_corporations_corporation_id_orders_with_http_info(self, corporation_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('corporation_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `corporation_id` when calling `get_corporations_corporation_id_orders`")

        if self.api_client.client_side_validation and ('corporation_id' in params and params['corporation_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `corporation_id` when calling `get_corporations_corporation_id_orders`, must be a value greater than or equal to `1`")
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_corporations_corporation_id_orders`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_corporations_corporation_id_orders_history_with_http_info(self, corporation_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('corporation_id' not in params or
                                                       params['corporation_id'] is None):
            raise ValueError(
                "Missing the required parameter `corporation_id` when calling `get_corporations_corporation_id_orders_history`")

        if self.api_client.client_side_validation and ('corporation_id' in params and params['corporation_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `corporation_id` when calling `get_corporations_corporation_id_orders_history`, must be a value greater than or equal to `1`")
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_corporations_corporation_id_orders_history`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_markets_groups_market_group_id_with_http_info(self, market_group_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('market_group_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `market_group_id` when calling `get_markets_groups_market_group_id`")
    ...
    def get_markets_region_id_orders_with_http_info(self, order_type, region_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_markets_region_id_orders`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_markets_region_id_types_with_http_info(self, region_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_markets_region_id_types`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_markets_structures_structure_id_with_http_info(self, structure_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('structure_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `structure_id` when calling `get_markets_structures_structure_id`")

        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_markets_structures_structure_id`, must be a value greater than or equal to `1`")
        collection_formats = {}
