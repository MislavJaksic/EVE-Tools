...
class ContactsApi(object):
    ...
    def delete_characters_character_id_contacts_with_http_info(self, character_id, contact_ids, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `character_id` when calling `delete_characters_character_id_contacts`")
        ...
        if self.api_client.client_side_validation and ('contact_ids' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `contact_ids` when calling `delete_characters_character_id_contacts`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `delete_characters_character_id_contacts`, must be a value greater than or equal to `1`")
        if self.api_client.client_side_validation and ('contact_ids' in params and
                                                       len(params['contact_ids']) > 20):
            raise ValueError(
                "Invalid value for parameter `contact_ids` when calling `delete_characters_character_id_contacts`, number of items must be less than or equal to `20`")
        if self.api_client.client_side_validation and ('contact_ids' in params and
                                                       len(params['contact_ids']) < 1):
            raise ValueError(
                "Invalid value for parameter `contact_ids` when calling `delete_characters_character_id_contacts`, number of items must be greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_alliances_alliance_id_contacts_with_http_info(self, alliance_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('alliance_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `alliance_id` when calling `get_alliances_alliance_id_contacts`")

        if self.api_client.client_side_validation and ('alliance_id' in params and params['alliance_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `alliance_id` when calling `get_alliances_alliance_id_contacts`, must be a value greater than or equal to `1`")
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_alliances_alliance_id_contacts`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_alliances_alliance_id_contacts_labels_with_http_info(self, alliance_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('alliance_id' not in params or
                                                       params['alliance_id'] is None):
            raise ValueError(
                "Missing the required parameter `alliance_id` when calling `get_alliances_alliance_id_contacts_labels`")

        if self.api_client.client_side_validation and ('alliance_id' in params and params['alliance_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `alliance_id` when calling `get_alliances_alliance_id_contacts_labels`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_characters_character_id_contacts_with_http_info(self, character_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
                                                       params['character_id'] is None):
            raise ValueError(
                "Missing the required parameter `character_id` when calling `get_characters_character_id_contacts`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `get_characters_character_id_contacts`, must be a value greater than or equal to `1`")
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_characters_character_id_contacts`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_characters_character_id_contacts_labels_with_http_info(self, character_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
                                                       params['character_id'] is None):
            raise ValueError(
                "Missing the required parameter `character_id` when calling `get_characters_character_id_contacts_labels`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `get_characters_character_id_contacts_labels`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_corporations_corporation_id_contacts_with_http_info(self, corporation_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('corporation_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `corporation_id` when calling `get_corporations_corporation_id_contacts`")

        if self.api_client.client_side_validation and ('corporation_id' in params and params['corporation_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `corporation_id` when calling `get_corporations_corporation_id_contacts`, must be a value greater than or equal to `1`")
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_corporations_corporation_id_contacts`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_corporations_corporation_id_contacts_labels_with_http_info(self, corporation_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('corporation_id' not in params or
                                                       params['corporation_id'] is None):
            raise ValueError(
                "Missing the required parameter `corporation_id` when calling `get_corporations_corporation_id_contacts_labels`")

        if self.api_client.client_side_validation and ('corporation_id' in params and params['corporation_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `corporation_id` when calling `get_corporations_corporation_id_contacts_labels`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def post_characters_character_id_contacts(self, character_id, contact_ids, standing, **kwargs):
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.post_characters_character_id_contacts_with_http_info(character_id, contact_ids, standing,
                                                                               **kwargs)
            return data
    ...
    def post_characters_character_id_contacts_with_http_info(self, character_id, contact_ids, standing, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
                                                       params['character_id'] is None):
            raise ValueError(
                "Missing the required parameter `character_id` when calling `post_characters_character_id_contacts`")
        # verify the required parameter 'contact_ids' is set
        if self.api_client.client_side_validation and ('contact_ids' not in params or
                                                       params['contact_ids'] is None):
            raise ValueError(
                "Missing the required parameter `contact_ids` when calling `post_characters_character_id_contacts`")
        ...
        if self.api_client.client_side_validation and ('standing' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `standing` when calling `post_characters_character_id_contacts`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `post_characters_character_id_contacts`, must be a value greater than or equal to `1`")
        if self.api_client.client_side_validation and ('standing' in params and params['standing'] > 10):
            raise ValueError(
                "Invalid value for parameter `standing` when calling `post_characters_character_id_contacts`, must be a value less than or equal to `10`")
        if self.api_client.client_side_validation and ('standing' in params and params['standing'] < -10):
            raise ValueError(
                "Invalid value for parameter `standing` when calling `post_characters_character_id_contacts`, must be a value greater than or equal to `-10`")
        if self.api_client.client_side_validation and ('label_ids' in params and
                                                       len(params['label_ids']) > 63):
            raise ValueError(
                "Invalid value for parameter `label_ids` when calling `post_characters_character_id_contacts`, number of items must be less than or equal to `63`")
        collection_formats = {}
    ...
    def put_characters_character_id_contacts(self, character_id, contact_ids, standing, **kwargs):
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.put_characters_character_id_contacts_with_http_info(character_id, contact_ids, standing,
                                                                              **kwargs)
            return data
    ...
    def put_characters_character_id_contacts_with_http_info(self, character_id, contact_ids, standing, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
                                                       params['character_id'] is None):
            raise ValueError(
                "Missing the required parameter `character_id` when calling `put_characters_character_id_contacts`")
        # verify the required parameter 'contact_ids' is set
        if self.api_client.client_side_validation and ('contact_ids' not in params or
                                                       params['contact_ids'] is None):
            raise ValueError(
                "Missing the required parameter `contact_ids` when calling `put_characters_character_id_contacts`")
        # verify the required parameter 'standing' is set
        if self.api_client.client_side_validation and ('standing' not in params or
                                                       params['standing'] is None):
            raise ValueError(
                "Missing the required parameter `standing` when calling `put_characters_character_id_contacts`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `put_characters_character_id_contacts`, must be a value greater than or equal to `1`")
        if self.api_client.client_side_validation and ('standing' in params and params['standing'] > 10):
            raise ValueError(
                "Invalid value for parameter `standing` when calling `put_characters_character_id_contacts`, must be a value less than or equal to `10`")
        if self.api_client.client_side_validation and ('standing' in params and params['standing'] < -10):
            raise ValueError(
                "Invalid value for parameter `standing` when calling `put_characters_character_id_contacts`, must be a value greater than or equal to `-10`")
        if self.api_client.client_side_validation and ('label_ids' in params and
                                                       len(params['label_ids']) > 63):
            raise ValueError(
                "Invalid value for parameter `label_ids` when calling `put_characters_character_id_contacts`, number of items must be less than or equal to `63`")
        collection_formats = {}
