...
class AssetsApi(object):
    ...
    def get_characters_character_id_assets_with_http_info(self, character_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `character_id` when calling `get_characters_character_id_assets`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `get_characters_character_id_assets`, must be a value greater than or equal to `1`")
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_characters_character_id_assets`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_corporations_corporation_id_assets_with_http_info(self, corporation_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('corporation_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `corporation_id` when calling `get_corporations_corporation_id_assets`")

        if self.api_client.client_side_validation and ('corporation_id' in params and params['corporation_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `corporation_id` when calling `get_corporations_corporation_id_assets`, must be a value greater than or equal to `1`")
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_corporations_corporation_id_assets`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def post_characters_character_id_assets_locations_with_http_info(self, character_id, item_ids, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
                                                       params['character_id'] is None):
            raise ValueError(
                "Missing the required parameter `character_id` when calling `post_characters_character_id_assets_locations`")
        ...
        if self.api_client.client_side_validation and ('item_ids' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `item_ids` when calling `post_characters_character_id_assets_locations`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `post_characters_character_id_assets_locations`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def post_characters_character_id_assets_names_with_http_info(self, character_id, item_ids, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
                                                       params['character_id'] is None):
            raise ValueError(
                "Missing the required parameter `character_id` when calling `post_characters_character_id_assets_names`")
        # verify the required parameter 'item_ids' is set
        if self.api_client.client_side_validation and ('item_ids' not in params or
                                                       params['item_ids'] is None):
            raise ValueError(
                "Missing the required parameter `item_ids` when calling `post_characters_character_id_assets_names`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `post_characters_character_id_assets_names`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def post_corporations_corporation_id_assets_locations(self, corporation_id, item_ids, **kwargs):
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.post_corporations_corporation_id_assets_locations_with_http_info(corporation_id, item_ids,
                                                                                           **kwargs)
            return data
    ...
    def post_corporations_corporation_id_assets_locations_with_http_info(self, corporation_id, item_ids, **kwargs):
        ...
        if self.api_client.client_side_validation and ('corporation_id' not in params or
                                                       params['corporation_id'] is None):
            raise ValueError(
                "Missing the required parameter `corporation_id` when calling `post_corporations_corporation_id_assets_locations`")
        # verify the required parameter 'item_ids' is set
        if self.api_client.client_side_validation and ('item_ids' not in params or
                                                       params['item_ids'] is None):
            raise ValueError(
                "Missing the required parameter `item_ids` when calling `post_corporations_corporation_id_assets_locations`")

        if self.api_client.client_side_validation and ('corporation_id' in params and params['corporation_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `corporation_id` when calling `post_corporations_corporation_id_assets_locations`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def post_corporations_corporation_id_assets_names(self, corporation_id, item_ids, **kwargs):
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.post_corporations_corporation_id_assets_names_with_http_info(corporation_id, item_ids,
                                                                                       **kwargs)
            return data
    ...
    def post_corporations_corporation_id_assets_names_with_http_info(self, corporation_id, item_ids, **kwargs):
        ...
        if self.api_client.client_side_validation and ('corporation_id' not in params or
                                                       params['corporation_id'] is None):
            raise ValueError(
                "Missing the required parameter `corporation_id` when calling `post_corporations_corporation_id_assets_names`")
        # verify the required parameter 'item_ids' is set
        if self.api_client.client_side_validation and ('item_ids' not in params or
                                                       params['item_ids'] is None):
            raise ValueError(
                "Missing the required parameter `item_ids` when calling `post_corporations_corporation_id_assets_names`")

        if self.api_client.client_side_validation and ('corporation_id' in params and params['corporation_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `corporation_id` when calling `post_corporations_corporation_id_assets_names`, must be a value greater than or equal to `1`")
        collection_formats = {}
