...
class LoyaltyApi(object):
    ...
    def get_characters_character_id_loyalty_points_with_http_info(self, character_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `character_id` when calling `get_characters_character_id_loyalty_points`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `get_characters_character_id_loyalty_points`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_loyalty_stores_corporation_id_offers_with_http_info(self, corporation_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('corporation_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `corporation_id` when calling `get_loyalty_stores_corporation_id_offers`")

        if self.api_client.client_side_validation and ('corporation_id' in params and params['corporation_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `corporation_id` when calling `get_loyalty_stores_corporation_id_offers`, must be a value greater than or equal to `1`")
        collection_formats = {}
