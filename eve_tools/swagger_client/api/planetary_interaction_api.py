...
class PlanetaryInteractionApi(object):
    ...
    def get_characters_character_id_planets_with_http_info(self, character_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `character_id` when calling `get_characters_character_id_planets`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `get_characters_character_id_planets`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_characters_character_id_planets_planet_id(self, character_id, planet_id, **kwargs):
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_characters_character_id_planets_planet_id_with_http_info(character_id, planet_id,
                                                                                       **kwargs)
            return data
    ...
    def get_characters_character_id_planets_planet_id_with_http_info(self, character_id, planet_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
                                                       params['character_id'] is None):
            raise ValueError(
                "Missing the required parameter `character_id` when calling `get_characters_character_id_planets_planet_id`")
        ...
        if self.api_client.client_side_validation and ('planet_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `planet_id` when calling `get_characters_character_id_planets_planet_id`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `get_characters_character_id_planets_planet_id`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_corporations_corporation_id_customs_offices_with_http_info(self, corporation_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('corporation_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `corporation_id` when calling `get_corporations_corporation_id_customs_offices`")

        if self.api_client.client_side_validation and ('corporation_id' in params and params['corporation_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `corporation_id` when calling `get_corporations_corporation_id_customs_offices`, must be a value greater than or equal to `1`")
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_corporations_corporation_id_customs_offices`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_universe_schematics_schematic_id_with_http_info(self, schematic_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('schematic_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `schematic_id` when calling `get_universe_schematics_schematic_id`")
