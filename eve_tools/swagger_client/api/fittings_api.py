...
class FittingsApi(object):
    ...
    def delete_characters_character_id_fittings_fitting_id(self, character_id, fitting_id, **kwargs):
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.delete_characters_character_id_fittings_fitting_id_with_http_info(character_id, fitting_id,
                                                                                            **kwargs)
            return data
    ...
    def delete_characters_character_id_fittings_fitting_id_with_http_info(self, character_id, fitting_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `character_id` when calling `delete_characters_character_id_fittings_fitting_id`")
        ...
        if self.api_client.client_side_validation and ('fitting_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `fitting_id` when calling `delete_characters_character_id_fittings_fitting_id`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `delete_characters_character_id_fittings_fitting_id`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_characters_character_id_fittings_with_http_info(self, character_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
                                                       params['character_id'] is None):
            raise ValueError(
                "Missing the required parameter `character_id` when calling `get_characters_character_id_fittings`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `get_characters_character_id_fittings`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def post_characters_character_id_fittings_with_http_info(self, character_id, fitting, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
                                                       params['character_id'] is None):
            raise ValueError(
                "Missing the required parameter `character_id` when calling `post_characters_character_id_fittings`")
        ...
        if self.api_client.client_side_validation and ('fitting' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `fitting` when calling `post_characters_character_id_fittings`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `post_characters_character_id_fittings`, must be a value greater than or equal to `1`")
        collection_formats = {}
