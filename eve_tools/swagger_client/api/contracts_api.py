...
class ContractsApi(object):
    ...
    def get_characters_character_id_contracts_with_http_info(self, character_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `character_id` when calling `get_characters_character_id_contracts`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `get_characters_character_id_contracts`, must be a value greater than or equal to `1`")
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_characters_character_id_contracts`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_characters_character_id_contracts_contract_id_bids(self, character_id, contract_id, **kwargs):
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_characters_character_id_contracts_contract_id_bids_with_http_info(character_id,
                                                                                                contract_id, **kwargs)
            return data

    def get_characters_character_id_contracts_contract_id_bids_with_http_info(self, character_id, contract_id,
                                                                              **kwargs):
        """Get contract bids
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
                                                       params['character_id'] is None):
            raise ValueError(
                "Missing the required parameter `character_id` when calling `get_characters_character_id_contracts_contract_id_bids`")
        # verify the required parameter 'contract_id' is set
        if self.api_client.client_side_validation and ('contract_id' not in params or
                                                       params['contract_id'] is None):
            raise ValueError(
                "Missing the required parameter `contract_id` when calling `get_characters_character_id_contracts_contract_id_bids`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `get_characters_character_id_contracts_contract_id_bids`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_characters_character_id_contracts_contract_id_items(self, character_id, contract_id, **kwargs):
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_characters_character_id_contracts_contract_id_items_with_http_info(character_id,
                                                                                                 contract_id, **kwargs)
            return data

    def get_characters_character_id_contracts_contract_id_items_with_http_info(self, character_id, contract_id,
                                                                               **kwargs):
        """Get contract items
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
                                                       params['character_id'] is None):
            raise ValueError(
                "Missing the required parameter `character_id` when calling `get_characters_character_id_contracts_contract_id_items`")
        # verify the required parameter 'contract_id' is set
        if self.api_client.client_side_validation and ('contract_id' not in params or
                                                       params['contract_id'] is None):
            raise ValueError(
                "Missing the required parameter `contract_id` when calling `get_characters_character_id_contracts_contract_id_items`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `get_characters_character_id_contracts_contract_id_items`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_contracts_public_bids_contract_id_with_http_info(self, contract_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('contract_id' not in params or
                                                       params['contract_id'] is None):
            raise ValueError(
                "Missing the required parameter `contract_id` when calling `get_contracts_public_bids_contract_id`")

        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_contracts_public_bids_contract_id`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_contracts_public_items_contract_id_with_http_info(self, contract_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('contract_id' not in params or
                                                       params['contract_id'] is None):
            raise ValueError(
                "Missing the required parameter `contract_id` when calling `get_contracts_public_items_contract_id`")

        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_contracts_public_items_contract_id`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_contracts_public_region_id_with_http_info(self, region_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_contracts_public_region_id`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_corporations_corporation_id_contracts_with_http_info(self, corporation_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('corporation_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `corporation_id` when calling `get_corporations_corporation_id_contracts`")

        if self.api_client.client_side_validation and ('corporation_id' in params and params['corporation_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `corporation_id` when calling `get_corporations_corporation_id_contracts`, must be a value greater than or equal to `1`")
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_corporations_corporation_id_contracts`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_corporations_corporation_id_contracts_contract_id_bids(self, contract_id, corporation_id, **kwargs):
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_corporations_corporation_id_contracts_contract_id_bids_with_http_info(contract_id,
                                                                                                    corporation_id,
                                                                                                    **kwargs)
            return data

    def get_corporations_corporation_id_contracts_contract_id_bids_with_http_info(self, contract_id, corporation_id,
                                                                                  **kwargs):
        """Get corporation contract bids
        ...
        if self.api_client.client_side_validation and ('contract_id' not in params or
                                                       params['contract_id'] is None):
            raise ValueError(
                "Missing the required parameter `contract_id` when calling `get_corporations_corporation_id_contracts_contract_id_bids`")
        # verify the required parameter 'corporation_id' is set
        if self.api_client.client_side_validation and ('corporation_id' not in params or
                                                       params['corporation_id'] is None):
            raise ValueError(
                "Missing the required parameter `corporation_id` when calling `get_corporations_corporation_id_contracts_contract_id_bids`")

        if self.api_client.client_side_validation and ('corporation_id' in params and params['corporation_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `corporation_id` when calling `get_corporations_corporation_id_contracts_contract_id_bids`, must be a value greater than or equal to `1`")
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_corporations_corporation_id_contracts_contract_id_bids`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_corporations_corporation_id_contracts_contract_id_items(self, contract_id, corporation_id, **kwargs):
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_corporations_corporation_id_contracts_contract_id_items_with_http_info(contract_id,
                                                                                                     corporation_id,
                                                                                                     **kwargs)
            return data

    def get_corporations_corporation_id_contracts_contract_id_items_with_http_info(self, contract_id, corporation_id,
                                                                                   **kwargs):
        """Get corporation contract items
        ...
        if self.api_client.client_side_validation and ('contract_id' not in params or
                                                       params['contract_id'] is None):
            raise ValueError(
                "Missing the required parameter `contract_id` when calling `get_corporations_corporation_id_contracts_contract_id_items`")
        # verify the required parameter 'corporation_id' is set
        if self.api_client.client_side_validation and ('corporation_id' not in params or
                                                       params['corporation_id'] is None):
            raise ValueError(
                "Missing the required parameter `corporation_id` when calling `get_corporations_corporation_id_contracts_contract_id_items`")

        if self.api_client.client_side_validation and ('corporation_id' in params and params['corporation_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `corporation_id` when calling `get_corporations_corporation_id_contracts_contract_id_items`, must be a value greater than or equal to `1`")
        collection_formats = {}
