...
class UserInterfaceApi(object):
    ...
    def post_ui_autopilot_waypoint(self, add_to_beginning, clear_other_waypoints, destination_id, **kwargs):
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.post_ui_autopilot_waypoint_with_http_info(add_to_beginning, clear_other_waypoints,
                                                                    destination_id, **kwargs)
            return data

    def post_ui_autopilot_waypoint_with_http_info(self, add_to_beginning, clear_other_waypoints, destination_id,
                                                  **kwargs):
        """Set Autopilot Waypoint
        ...
        if self.api_client.client_side_validation and ('add_to_beginning' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `add_to_beginning` when calling `post_ui_autopilot_waypoint`")
        ...
        if self.api_client.client_side_validation and ('clear_other_waypoints' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `clear_other_waypoints` when calling `post_ui_autopilot_waypoint`")
        # verify the required parameter 'destination_id' is set
        if self.api_client.client_side_validation and ('destination_id' not in params or
                                                       params['destination_id'] is None):
            raise ValueError(
                "Missing the required parameter `destination_id` when calling `post_ui_autopilot_waypoint`")
    ...
    def post_ui_openwindow_newmail(self, new_mail, **kwargs):
        ...
        :param async_req bool
        :param NewMail new_mail: The details of mail to create (required)
        :param str datasource: The server name you would like data from
        :param str token: Access token to use if unable to set a header
        :return: None
                 If the method is called asynchronously,
