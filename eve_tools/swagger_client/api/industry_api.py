...
class IndustryApi(object):
    ...
    def get_characters_character_id_industry_jobs_with_http_info(self, character_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `character_id` when calling `get_characters_character_id_industry_jobs`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `get_characters_character_id_industry_jobs`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_characters_character_id_mining_with_http_info(self, character_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('character_id' not in params or
                                                       params['character_id'] is None):
            raise ValueError(
                "Missing the required parameter `character_id` when calling `get_characters_character_id_mining`")

        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `get_characters_character_id_mining`, must be a value greater than or equal to `1`")
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_characters_character_id_mining`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_corporation_corporation_id_mining_extractions_with_http_info(self, corporation_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('corporation_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `corporation_id` when calling `get_corporation_corporation_id_mining_extractions`")

        if self.api_client.client_side_validation and ('corporation_id' in params and params['corporation_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `corporation_id` when calling `get_corporation_corporation_id_mining_extractions`, must be a value greater than or equal to `1`")
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_corporation_corporation_id_mining_extractions`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_corporation_corporation_id_mining_observers_with_http_info(self, corporation_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('corporation_id' not in params or
                                                       params['corporation_id'] is None):
            raise ValueError(
                "Missing the required parameter `corporation_id` when calling `get_corporation_corporation_id_mining_observers`")

        if self.api_client.client_side_validation and ('corporation_id' in params and params['corporation_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `corporation_id` when calling `get_corporation_corporation_id_mining_observers`, must be a value greater than or equal to `1`")
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_corporation_corporation_id_mining_observers`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_corporation_corporation_id_mining_observers_observer_id(self, corporation_id, observer_id, **kwargs):
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_corporation_corporation_id_mining_observers_observer_id_with_http_info(corporation_id,
                                                                                                     observer_id,
                                                                                                     **kwargs)
            return data

    def get_corporation_corporation_id_mining_observers_observer_id_with_http_info(self, corporation_id, observer_id,
                                                                                   **kwargs):
        """Observed corporation mining
        ...
        if self.api_client.client_side_validation and ('corporation_id' not in params or
                                                       params['corporation_id'] is None):
            raise ValueError(
                "Missing the required parameter `corporation_id` when calling `get_corporation_corporation_id_mining_observers_observer_id`")
        ...
        if self.api_client.client_side_validation and ('observer_id' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `observer_id` when calling `get_corporation_corporation_id_mining_observers_observer_id`")

        if self.api_client.client_side_validation and ('corporation_id' in params and params['corporation_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `corporation_id` when calling `get_corporation_corporation_id_mining_observers_observer_id`, must be a value greater than or equal to `1`")
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_corporation_corporation_id_mining_observers_observer_id`, must be a value greater than or equal to `1`")
        collection_formats = {}
    ...
    def get_corporations_corporation_id_industry_jobs_with_http_info(self, corporation_id, **kwargs):
        ...
        if self.api_client.client_side_validation and ('corporation_id' not in params or
                                                       params['corporation_id'] is None):
            raise ValueError(
                "Missing the required parameter `corporation_id` when calling `get_corporations_corporation_id_industry_jobs`")

        if self.api_client.client_side_validation and ('corporation_id' in params and params['corporation_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `corporation_id` when calling `get_corporations_corporation_id_industry_jobs`, must be a value greater than or equal to `1`")
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):
            raise ValueError(
                "Invalid value for parameter `page` when calling `get_corporations_corporation_id_industry_jobs`, must be a value greater than or equal to `1`")
        collection_formats = {}
