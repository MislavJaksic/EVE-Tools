...
class SearchApi(object):
    ...
    def get_characters_character_id_search_with_http_info(self, categories, character_id, search, **kwargs):
        ...
        all_params = ['categories', 'character_id', 'search', 'accept_language', 'datasource', 'if_none_match',
                      'language', 'strict', 'token']
        ...
        if self.api_client.client_side_validation and ('categories' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `categories` when calling `get_characters_character_id_search`")
        # verify the required parameter 'character_id' is set
        if self.api_client.client_side_validation and ('character_id' not in params or
                                                       params['character_id'] is None):
            raise ValueError(
                "Missing the required parameter `character_id` when calling `get_characters_character_id_search`")
        # verify the required parameter 'search' is set
        if self.api_client.client_side_validation and ('search' not in params or
                                                       params['search'] is None):
            raise ValueError(
                "Missing the required parameter `search` when calling `get_characters_character_id_search`")

        if self.api_client.client_side_validation and ('categories' in params and
                                                       len(params['categories']) > 11):
            raise ValueError(
                "Invalid value for parameter `categories` when calling `get_characters_character_id_search`, number of items must be less than or equal to `11`")
        if self.api_client.client_side_validation and ('categories' in params and
                                                       len(params['categories']) < 1):
            raise ValueError(
                "Invalid value for parameter `categories` when calling `get_characters_character_id_search`, number of items must be greater than or equal to `1`")
        if self.api_client.client_side_validation and ('character_id' in params and params['character_id'] < 1):
            raise ValueError(
                "Invalid value for parameter `character_id` when calling `get_characters_character_id_search`, must be a value greater than or equal to `1`")
        if self.api_client.client_side_validation and ('search' in params and
                                                       len(params['search']) < 3):
            raise ValueError(
                "Invalid value for parameter `search` when calling `get_characters_character_id_search`, length must be greater than or equal to `3`")
        collection_formats = {}
    ...
    def get_search_with_http_info(self, categories, search, **kwargs):
        ...
        if self.api_client.client_side_validation and ('categories' in params and
            ...
            raise ValueError(
                "Invalid value for parameter `categories` when calling `get_search`, number of items must be less than or equal to `10`")
        if self.api_client.client_side_validation and ('categories' in params and
                                                       len(params['categories']) < 1):
            raise ValueError(
                "Invalid value for parameter `categories` when calling `get_search`, number of items must be greater than or equal to `1`")
        if self.api_client.client_side_validation and ('search' in params and
                                                       len(params['search']) < 3):
            raise ValueError(
                "Invalid value for parameter `search` when calling `get_search`, length must be greater than or equal to `3`")
        collection_formats = {}
