...
class EveDatastore:
    ...
    def get_kills(self):
        systems = self.get_json(
            "get_universe_systems", expire_timedelta=timedelta(minutes=1)
        )
        empty_kills = []
        ...
        system_kills = self.get_json("get_universe_system_kills")
    ...
    def get_systems(self):
        return self.get_json("get_universe_systems")
