...
> list[object] get_characters_character_id_bookmarks(character_id, datasource=datasource, if_none_match=if_none_match, page=page, token=token)
...
api_instance = swagger_client.BookmarksApi(swagger_client.ApiClient(configuration))
...
> list[object] get_characters_character_id_bookmarks_folders(character_id, datasource=datasource, if_none_match=if_none_match, page=page, token=token)
...
> list[object] get_corporations_corporation_id_bookmarks(corporation_id, datasource=datasource, if_none_match=if_none_match, page=page, token=token)
...
> list[object] get_corporations_corporation_id_bookmarks_folders(corporation_id, datasource=datasource, if_none_match=if_none_match, page=page, token=token)
