...
> object get_characters_character_id_attributes(character_id, datasource=datasource, if_none_match=if_none_match, token=token)
...
api_instance = swagger_client.SkillsApi(swagger_client.ApiClient(configuration))
...
> list[object] get_characters_character_id_skillqueue(character_id, datasource=datasource, if_none_match=if_none_match, token=token)
...
> object get_characters_character_id_skills(character_id, datasource=datasource, if_none_match=if_none_match, token=token)
