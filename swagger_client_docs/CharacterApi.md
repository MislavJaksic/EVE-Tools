...
> object get_characters_character_id(character_id, datasource=datasource, if_none_match=if_none_match)
...
> list[object] get_characters_character_id_agents_research(character_id, datasource=datasource, if_none_match=if_none_match, token=token)
...
> list[object] get_characters_character_id_blueprints(character_id, datasource=datasource, if_none_match=if_none_match, page=page, token=token)
...
> list[object] get_characters_character_id_corporationhistory(character_id, datasource=datasource, if_none_match=if_none_match)
...
> object get_characters_character_id_fatigue(character_id, datasource=datasource, if_none_match=if_none_match, token=token)
...
> list[object] get_characters_character_id_medals(character_id, datasource=datasource, if_none_match=if_none_match, token=token)
...
> list[object] get_characters_character_id_notifications(character_id, datasource=datasource, if_none_match=if_none_match, token=token)
...
> list[object] get_characters_character_id_notifications_contacts(character_id, datasource=datasource, if_none_match=if_none_match, token=token)
...
> object get_characters_character_id_portrait(character_id, datasource=datasource, if_none_match=if_none_match)
...
> object get_characters_character_id_roles(character_id, datasource=datasource, if_none_match=if_none_match, token=token)
...
> list[object] get_characters_character_id_standings(character_id, datasource=datasource, if_none_match=if_none_match, token=token)
...
> list[object] get_characters_character_id_titles(character_id, datasource=datasource, if_none_match=if_none_match, token=token)
...
> list[object] post_characters_affiliation(characters, datasource=datasource)
...
# create an instance of the API class
api_instance = swagger_client.CharacterApi()
characters = [swagger_client.list[int]()] # list[int] | The character IDs to fetch affiliations for. All characters must exist, or none will be returned
datasource = 'tranquility' # str | The server name you would like data from (optional) (default to tranquility)
...
api_instance = swagger_client.CharacterApi(swagger_client.ApiClient(configuration))
character_id = 56 # int | An EVE character ID
characters = [swagger_client.list[int]()] # list[int] | The target characters to calculate the charge for
datasource = 'tranquility' # str | The server name you would like data from (optional) (default to tranquility)
token = 'token_example' # str | Access token to use if unable to set a header (optional)
